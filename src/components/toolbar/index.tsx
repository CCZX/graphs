    ...
    <div id="toolbar">
      ...
      <div className="tb-group">
        {([
          ...
          [ToolType.Pen, '画笔 (P)', 'M12 20h9', 'M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z'],
          [ToolType.Rect, '矩形 (R)', '', ''],
          [ToolType.Circle, '圆形 (C)', '', ''],
          [ToolType.Line, '直线 (L)', '', ''],
          [ToolType.Arrow, '箭头 (A)', '', ''],
          [ToolType.Text, '文字 (T)', 'M4 7V4h16v3', 'M9 20h6', 'M12 4v16'],
          [ToolType.Eraser, '橡皮擦 (E)', 'M20 20H7L3 16c-.8-.8-.8-2 0-2.8L14 2.2c.8-.8 2-.8 2.8 0l4.8 4.8c.8.8.8 2 0 2.8L12 20', 'M18 12l-6 6'],
        ] as [ToolType, string, ...string[]][]).map(([tool, title, ...paths]) => (
          <button
            key={tool}
